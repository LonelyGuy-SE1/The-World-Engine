...
export const GearIcon: React.FC<IconProps> = ({ size = 16, color = "currentColor", className }) => (
...
export const FlaskIcon: React.FC<IconProps> = ({ size = 16, color = "currentColor", className }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const StepIcon: React.FC<IconProps> = ({ size = 16, color = "currentColor", className }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill={color} stroke="none" className={className}>
